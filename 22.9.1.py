...
if " " not in sequence_numbers:    ### Проверка соответствия указанному в условии ввода данных.
...
list_sequence_numbers = [int(item) for item in sequence_numbers] ### Меняем список строк на список чисел
